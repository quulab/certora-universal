...
} from "@openzeppelin-contracts-5.5.0/interfaces/draft-IERC7579.sol";
import {ERC7579Utils, Mode, CallType, ExecType} from "@openzeppelin-contracts-5.5.0/account/utils/draft-ERC7579Utils.sol";
import {EnumerableSet} from "@openzeppelin-contracts-5.5.0/utils/structs/EnumerableSet.sol";
import {LowLevelCall} from "@openzeppelin-contracts-5.5.0/utils/LowLevelCall.sol";
import {Bytes} from "@openzeppelin-contracts-5.5.0/utils/Bytes.sol";
import {Packing} from "@openzeppelin-contracts-5.5.0/utils/Packing.sol";
import {Calldata} from "@openzeppelin-contracts-5.5.0/utils/Calldata.sol";
 ...
 */
abstract contract AccountERC7579Patched is Account, IERC1271, IERC7579Execution, IERC7579AccountConfig, IERC7579ModuleConfig {
    using Bytes for *;
