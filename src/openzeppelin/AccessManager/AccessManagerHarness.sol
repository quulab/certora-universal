...
import {AccessManagerPatched} from "./AccessManagerPatched.sol";

contract AccessManagerHarness is AccessManagerPatched {
    // override with a storage slot that can basically take any value.
    uint32 private _minSetback;

    constructor(address initialAdmin) AccessManagerPatched(initialAdmin) {}
